...
const objects = require ( "./data/spots" );

console.log( "Dropping old collection" );
collections.ResourceSpots.collection.drop();
...
function save( index, res, rej )
{
  ...
  collections.ResourceSpots.createOnTileCreated( o.resId, o.x + map_offset, o.y + map_offset )
  .then( () => {
